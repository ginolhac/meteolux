---
title: "Meteolux"
author: "Gonella Luca, Bodart Céline, Al Sawaf Haya"
date: "2022-04-28"
...
```{r}
library(tidyverse)
findel_rain<-read_csv("https://data.public.lu/fr/datasets/daily-meteorological-parameters-luxembourg-findel-airport-wmo-id-06590/")
```
...
Now that you know how to create the decades, you can summarise by them both
